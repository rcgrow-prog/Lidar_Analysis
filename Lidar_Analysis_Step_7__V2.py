...
This Python script automates a standard hydrologic terrain analysis workflow using ArcPy and the ArcGIS Spatial Analyst extension. 
It processes a Digital Elevation Model (DEM) to generate filled elevation, flow direction, flow accumulation, and stream order 
rasters using both D8 and DINF flow algorithms.
'''
import arcpy
